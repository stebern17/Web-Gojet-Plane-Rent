...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | Rental Pesawat</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    <!-- <div class="jumbotron pt-4 pb-4">
        <div class="row">
            <div class="col-sm-8">
                <h2><b style="text-transform:uppercase;"><?= $info_web->corp_name;?> </b></h2>
            </div>
        </div>
    </div> -->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar Pesawat'){ echo 'active';}?>
                <?php if($title_web == 'Tambah Pesawat'){ echo 'active';}?>
                <?php if($title_web == 'Edit Pesawat'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/pesawat/pesawat.php">Daftar Pesawat</a>
                </li>
