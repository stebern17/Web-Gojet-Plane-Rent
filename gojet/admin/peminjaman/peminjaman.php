...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php }?>
                <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Free makan 1x</li>
    ...
    <div class="col-sm-8">
         <div class="card">
            <div class="card-header">
                <h5 class="card-title">Detail Booking & Status Pesawat</h5>
            </div>
           <div class="card-body">
               <form method="post" action="proses.php?id=konfirmasi">
                    ...
                    <input type="hidden" name="id_jet" value="<?php echo $isi['id_jet'];?>">
