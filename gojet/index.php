...
<!-- menampilkan carousel yang berisi gambar-gambar pesawat dari queryprivat_jet. Terdapat indikator slide dan
item slide yang ditampilkan sesuai dengan data yang diperoleh dari queryprivat_jet. Setiap item slide menampilkan
gambar pesawat dengan ukuran yang disesuaikan dan menggunakan objek-fit untuk mengatur tampilan gambar. -->
<div id="carouselId" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
        <?php 
            $queryprivat_jet =  $koneksi -> query('SELECT * FROM privat_jet ORDER BY id_jet DESC')->fetchAll();
            $no =1;
            foreach($queryprivat_jet as $isi)
            {
        ?>
...
<div class="container mx-2 mt-3">
        <h1 class="text-center mx-auto">Selamat Datang!!! </h1>
    <div class="row">
        <div class="col-sm-3">
        ...
        <div class="col-sm-9">
            <div class="row">
                <?php 
                    $query =  $koneksi -> query('SELECT * FROM privat_jet ORDER BY id_jet DESC')->fetchAll();
                    $no =1;
                ...
                <div class="col-sm-4">
                    ...
                    <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;">
                        ...
                        <li class="list-group-item bg-dark text-white">
                            <i class="fa fa-money"></i> USD. <?php echo number_format($isi['harga']);?>/ day
                        </li>
                        </ul>
                        <div class="card-body">
                        <center><a href="booking.php?id=<?php echo $isi['id_jet'];?>" class="btn btn-success">Booking now!</a>
                        <a href="detail.php?id=<?php echo $isi['id_jet'];?>" class="btn btn-info">Detail</a></center>
                        </div>
                    </div>
                </div>
                <?php $no++;}?>
