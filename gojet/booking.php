<?php
    ...
    $id = $_GET['id']; // Mengambil nilai dari parameter 'id' yang dikirim melalui metode GET
    $isi = $koneksi->query("SELECT * FROM privat_jet WHERE id_jet = '$id'")->fetch(); // Melakukan query untuk mendapatkan data privat_jet berdasarkan id_jet yang diberikan dan mengambil satu baris hasil query
?>
         ...
         <div class="card">
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=booking">
                    ...
                    <input type="hidden" value="<?php echo $isi['id_jet'];?>" name="id_jet">
